...
chrome_options.add_argument('--headless')  # headless chrome for less overhead and faster
...
ico_links = driver.find_elements_by_xpath('//*[@id="ajaxc"]/div/div/div[*]/a') # get all ico page links
...
for i in range(len(ico_links) - 1):
    ...
    interest = driver.find_element_by_xpath('//*[@id="ajaxc"]/div/div/div[' + i + ']/a/div/div[2]').text
    fundraising_goal = driver.find_element_by_xpath('//*[@id="ajaxc"]/div/div/div[' + i + ']/a/div/div[4]').text
    ico_date = driver.find_element_by_xpath('//*[@id="ajaxc"]/div/div/div[' + i + ']/a/div/div[5]').text
    ...
    ico_start_date = driver.find_element_by_class_name('sale-date').get_attribute('data-date')
    ...
    try:
        telegram_link = driver.find_element_by_css_selector('.soc_links a[href^="https://t.me"]').get_attribute('href')
    except:
        telegram_link = ''
    try:
        twitter_link = driver.find_element_by_css_selector('.soc_links a[href^="https://twitter"]').get_attribute('href')
    except:
        twitter_link = ''
    try:
        medium_link = driver.find_element_by_css_selector('.soc_links a[href^="https://medium"]')
    except:
        medium_link = ''
    ...
    if twitter_link:
        ...
        num_twitter_followers = driver.find_element_by_xpath('//*[@id="page-container"]/div[1]/div/div[2]/div/div/div[2]/div/div/ul/li[3]/a/span[3]').text
